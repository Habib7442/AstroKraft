...
- Updated social media profile links: updated the central Facebook and Instagram URLs inside [seo.ts](file:///e:/Web%20Dev/astrokraft/lib/seo.ts), propagating the correct links to the website footer and metadata schemas.
