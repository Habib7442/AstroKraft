...
- Integrated the animated pointer-highlight component: created a reusable sentence-splitting wrapper component at [pointer-highlight-text.tsx](file:///e:/Web%20Dev/astrokraft/components/pointer-highlight-text.tsx) using the [pointer-highlight.tsx](file:///e:/Web%20Dev/astrokraft/components/ui/pointer-highlight.tsx) canvas boundary-drawing mechanism. Integrated this component into the hero display title in [hero.tsx](file:///e:/Web%20Dev/astrokraft/components/sections/hero.tsx) to draw a golden spotlight rectangle around the "AstroKraft" brand name when scrolled into view.
